...
class KittiDataset(DatasetTemplate):
    ...
    def get_lidar_pseudo(self, idx):
        lidar_pseudo_file = self.root_split_path / 'pseudo_velodyne' / ('%s.bin' % idx)
    ...
    def create_groundtruth_database(self, info_path=None, used_classes=None, split='train'):
        ...
        database_save_path_pseudo = Path(self.root_path) / ('gt_database_pseudo' if split == 'train' else ('gt_database_%s_pseudo' % split)) 
        ...
        for k in tqdm.tqdm(range(len(infos))):
    ...
    def collate_batch(batch_list, _unused=False):
        ...
        if 'valid_noise' in data_dict.keys():
