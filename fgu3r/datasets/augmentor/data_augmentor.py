...
class DataAugmentor(object):
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        for cur_axis in config['ALONG_AXIS_LIST']:
            ...
            gt_boxes, points, points_pseudo = getattr(augmentor_utils, 'random_flip_along_%s' % cur_axis)(
    ...
    def random_world_rotation(self, data_dict=None, config=None):
        ...
        if not isinstance(rot_range, list):
            rot_range = [-rot_range, rot_range]
        gt_boxes, points, points_pseudo = augmentor_utils.global_rotation(
    ...
    def random_world_scaling(self, data_dict=None, config=None):
        ...
        gt_boxes, points, points_pseudo = augmentor_utils.global_scaling(
    ...
    def random_local_noise(self, data_dict=None, config=None): # 时间长
        if data_dict is None:
            return partial(self.random_local_noise, config=config)
        data_dict['gt_boxes'][:, 6] = -data_dict['gt_boxes'][:, 6] # 方向掉头
        augmentor_utils.noise_per_object_v3_(data_dict['gt_boxes'], data_dict['points'], data_dict['points_pseudo'], 
