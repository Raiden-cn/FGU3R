...
class Detector3DTemplate(nn.Module):
    ...
    def build_networks(self):
        model_info_dict = {
            ...
            'num_pseudopoint_features': self.dataset.point_feature_encoder.num_point_features_pseudo,
    ...
    def build_pfe(self, model_info_dict):
        ...
        pfe_module = pfe.__all__[self.model_cfg.PFE.NAME](
            ...
            num_pseudopoint_features = model_info_dict['num_pseudopoint_features']
        )
